...
//declare variable for document element with Id of lefarrow, witch is the html document
var leftarrow = document.getElementById("leftarrow");

//add an event handler to the specified element (leftarrow)
//the leftArrow() function will be excecuted when the user clicks the left navigation arrow button

leftarrow.addEventListener("click", leftArrow, false);

//declare variable for document element with Id os rightarrow in the html document
var rightarrow = document.getElementById("rightarrow");

//add an event handler to the specified document element (rightarrow)
//the rightArrow() function will executes when the user clicks the right navigation arrow
